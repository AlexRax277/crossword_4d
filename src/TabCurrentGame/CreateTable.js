/**
 * Функция создания игрового поля. Пока в хранилище не занесены слова, функция выводит текст-заглушку вместо игрового поля.
 * Для режима "простой" прячет кнопку проверки поля.
 */
